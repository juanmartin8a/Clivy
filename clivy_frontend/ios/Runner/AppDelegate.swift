...
@objc class AppDelegate: FlutterAppDelegate {
  ...
  //     // NSLog(animationCurveRawNSN);
  //     // NSLog(animationCurveRaw);
  //     // NSLog(animationCurve);
        
  //     if let startFrame = startFrame, let endFrame = endFrame {
  //       // NSLog(startFrame.size.height)
  //       // NSLog(endFrame.size.height)
  ...
  //         methodChannel?.invokeMethod("kbshow", arguments: animationCurveRaw)

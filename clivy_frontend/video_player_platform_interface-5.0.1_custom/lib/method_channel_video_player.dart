...
class MethodChannelVideoPlayer extends VideoPlayerPlatform {
  ...
  @override
  Future<void> pauseBuffering(int textureId) {
    return _api.pauseBuffering(TextureMessage()..textureId = textureId);
  }

  @override
  Future<void> playBuffering(int textureId) {
    return _api.playBuffering(TextureMessage()..textureId = textureId);
  }
